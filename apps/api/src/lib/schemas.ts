...
// Import these into route files instead of repeating schema inline.
//
// Usage:
//   import { idParam, productIdParam, productFilterQuery } from "../lib/schemas"
...
// page/limit are strings because Fastify receives query params as strings.
// Enum on game/condition/sort prevents arbitrary values reaching the DB.
...
// Reusable address fields with maxLength. required array is added per-route.
